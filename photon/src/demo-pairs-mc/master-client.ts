...
class MasterClient {
    ...
    private InitGame(trivial?: boolean, players?: Array<string>) {
        ...
        this.game.mapProgress = new Array<number>();
        this.NextPlayer(0);
